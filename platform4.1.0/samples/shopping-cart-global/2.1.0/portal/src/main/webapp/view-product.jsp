<%@ page import="com.acme.shoppingcart.portal.PortalUtils" %>
...
<head>
    ...
    <script type="text/javascript">
        var serviceEPR = '<%= PortalUtils.getProperty("related.products.epr") %>';
    </script>
    ...
    <div class="content">
        <table class="contentTable">
            <tr>
                ...
                <td class="contentCol">
                    <h1 id="product-title"><%=product.getProductName()%>
                    </h1>
                    ...
                    <div class="item-content-box">
                        <table class="data-table">
                            ...
                            <tr>
                                <th>Price:</th>
                                <td class="item-price"><%=product.getPrice()%>
                                </td>
                            </tr>
                            <tr>
                                <th>Vendor :</th>
                    ...
                    <div id="related-products-heading" class="page-headding" style="display:none">
                        <h1>Related
                            Items</h1>
                    </div>
                    <!-- TODO: From Mashup -->
