...
public class TestExecuteEsb extends MasterTestSuite {
    @BeforeSuite
    public void execute() {
        System.setProperty("server.list", "ESB,AS,IS");
        List<SuiteVariables> suiteVariablesList=new ArrayList<SuiteVariables>();
        suiteVariablesList.add(new SuiteVariables("test123", sampleTestScenario.class));
        superSuite("IsUploadSuite",suiteVariablesList).run();
    }

    public static void main(String[] args) {
        new TestExecuteEsb().execute();
    }
