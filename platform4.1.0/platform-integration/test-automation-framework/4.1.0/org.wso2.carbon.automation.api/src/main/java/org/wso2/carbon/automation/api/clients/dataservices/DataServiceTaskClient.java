...
public class DataServiceTaskClient {
    ...
    public DataServiceTaskClient(String backEndUrl, String sessionCookie) throws AxisFault {
        ...
        try {
            ...
            log.error("Unable to initialize dsTaskAdminStub", axisFault);
            throw new AxisFault("Unable to initialize dsTaskAdminStub", axisFault);
        }
        AuthenticateStub.authenticateStub(sessionCookie, dsTaskAdminStub);
    }
    ...
    public DataServiceTaskClient(String backEndUrl, String userName, String password)
        ...
        AuthenticateStub.authenticateStub(userName, password, dsTaskAdminStub);
    }
