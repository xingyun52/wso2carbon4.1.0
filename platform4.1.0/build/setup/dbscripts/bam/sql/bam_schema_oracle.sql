CREATE TABLE  BAM_ACTIVITY (
  ...
  BAM_DESCRIPTION VARCHAR2(1024) NOT NULL,
  BAM_USER_DEFINED_ID VARCHAR2(36) NOT NULL,
  PRIMARY KEY (BAM_ID))
 /
...
CREATE TABLE BAM_MESSAGE (
  ...
  BAM_MSG_ID VARCHAR2(45) NOT NULL, -- 'WS-ADDRESSING MESSAGE ID',
  BAM_ACTIVITY_ID INT  NULL,
  BAM_TIMESTAMP TIMESTAMP NOT NULL,
  BAM_IP_ADDRESS VARCHAR2(45) NOT NULL,
  BAM_USER_AGENT VARCHAR2(45) NOT NULL,
  PRIMARY KEY (BAM_ID))
 /
