...
/**
 * We keep information regarding to a service (i.e. a cartridge instance)
 * in this object.
 */
...
//    }
	...
	public Node toNode() {
		...
		String newLine = "\n";
		String ip = properties.get(CloudControllerConstants.PUBLIC_IP_PROPERTY);
		//FIXME add all properties to this
		String nginx = 
				Constants.DOMAIN_ELEMENT+sbrace+newLine+
				domainName+sbrace+newLine+
				CloudControllerConstants.PUBLIC_IP_PROPERTY+" "+(ip == null ? "":ip)+delimiter+newLine+
