...
public class CloudControllerServiceReferenceHolder {

    private static CloudControllerServiceReferenceHolder instance;
    private TaskService taskService;
    private ConfigurationPublisher configPub;
    private Registry registry;
    
    private CloudControllerServiceReferenceHolder() {
    }

    public static CloudControllerServiceReferenceHolder getInstance() {
        if (instance == null) {
            instance = new CloudControllerServiceReferenceHolder();
        }
        return instance;
    }
