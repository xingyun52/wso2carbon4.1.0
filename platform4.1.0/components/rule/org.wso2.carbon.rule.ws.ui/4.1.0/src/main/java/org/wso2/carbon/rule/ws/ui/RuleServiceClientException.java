...
public class RuleServiceClientException extends RuntimeException {
    ...
    public RuleServiceClientException(String message) {
        super(message);
    }

    public RuleServiceClientException(String message, Throwable cause) {
        super(message, cause);
    }

    public RuleServiceClientException(Throwable cause) {
        super(cause);
    }
}
