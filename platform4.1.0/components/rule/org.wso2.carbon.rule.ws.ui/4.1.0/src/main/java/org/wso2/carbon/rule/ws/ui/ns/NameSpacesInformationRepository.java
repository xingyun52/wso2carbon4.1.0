...
/**
 * Keeps NameSpacesInformation instances
 */
public class NameSpacesInformationRepository {

    public static final String NAMESPACES_INFORMATION_REPOSITORY = "NameSpacesInformationRepository";

    private final Map<String, NameSpacesOwner> nameSpacesOwnerInfo = new HashMap<String, NameSpacesOwner>();

    public void addNameSpacesInformation(String ownerID,
                                         String id,
