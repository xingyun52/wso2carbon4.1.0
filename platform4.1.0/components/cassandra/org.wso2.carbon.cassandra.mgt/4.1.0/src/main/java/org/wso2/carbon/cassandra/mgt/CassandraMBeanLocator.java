...
public class CassandraMBeanLocator {
    ...
    public StreamingServiceMBean locateStreamingServiceMBean() throws CassandraServerManagementException {
        if (streamProxy == null) {
            streamProxy = locateMBean(StreamingService.MBEAN_OBJECT_NAME, StreamingServiceMBean.class);
        }
        return streamProxy;
    }
    ...
    public ColumnFamilyStoreMBean locateColumnFamilyStoreMBean(String ks, String cf) throws CassandraServerManagementException {
        if (columnFamilyStoreMBean == null) {
            columnFamilyStoreMBean = locateMBean("org.apache.cassandra.db:type=ColumnFamilies,keyspace=" + ks +
                    ",columnfamily=" + cf, ColumnFamilyStoreMBean.class);
        }
