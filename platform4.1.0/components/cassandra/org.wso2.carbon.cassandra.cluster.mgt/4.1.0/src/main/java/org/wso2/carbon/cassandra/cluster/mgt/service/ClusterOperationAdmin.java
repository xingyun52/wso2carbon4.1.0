...
public class ClusterOperationAdmin extends AbstractAdmin{
     ...
     */
    public boolean scrubKeyspace(String keyspace) throws ClusterDataAdminException {
        return ClusterMBeanProxy.getClusterStorageMBeanService().scrub(keyspace);
    }
     ...
     */
    public boolean scrubColumnFamilies(String keyspace,String[] columnFamilies) throws
                                                                                ClusterDataAdminException {
        return ClusterMBeanProxy.getClusterStorageMBeanService().scrub(keyspace,columnFamilies);
    }
     ...
     */
    public boolean upgradeSSTablesInKeyspace(String keyspace) throws
                                                              ClusterDataAdminException {
     ...
     */
    public boolean upgradeSSTablesColumnFamilies(String keyspace,String[] columnFamilies) throws
                                                                                          ClusterDataAdminException {
        return ClusterMBeanProxy.getClusterStorageMBeanService().upgradeSSTables(keyspace,columnFamilies);
    }
     ...
     * @throws ClusterDataAdminException
     */
    public void removeToken(String token) throws ClusterDataAdminException {
        ClusterMBeanProxy.getClusterStorageMBeanService().removeToken(token);
    }
