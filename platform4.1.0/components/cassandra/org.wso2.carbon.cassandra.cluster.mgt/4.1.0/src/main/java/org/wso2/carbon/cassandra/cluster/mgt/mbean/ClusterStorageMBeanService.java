...
public class ClusterStorageMBeanService {
    ...
    public boolean joinRing() throws ClusterDataAdminException {
        try {
            ...
            throw new ClusterDataAdminException("Cannot join the ring.Cause due to configuration exception",e,log);
        }
    }
    ...
    public boolean repair(String keyspace, String... columnFamily) throws
                                                                   ClusterDataAdminException {
        try {
            storageServiceMBean.forceTableRepair(keyspace,false,columnFamily);
            return true;
        } catch (IOException e) {
    ...
    public boolean moveNode(String newToken) throws ClusterDataAdminException {
        try {
            ...
            throw new ClusterDataAdminException("Cannot move the node.Cause due to interrupted exception",e,log);
        } catch (ConfigurationException e) {
            throw new ClusterDataAdminException("Cannot move the node.Cause due to configuration exception",e,log);
        }
    }
     ...
     * @throws ClusterDataAdminException
     */
    public boolean scrub(String keyspace,String... columnFamilies) throws
                                                                   ClusterDataAdminException {
        try {
     ...
     * @throws ClusterDataAdminException
     */
    public boolean upgradeSSTables(String keyspace,String... columnFamilies) throws
                                                                             ClusterDataAdminException {
        try {
    ...
    {
        storageServiceMBean.removeToken(token);
    }
    ...
    public String getEndpoint()
    {
        ...
        String stringToken = storageServiceMBean.getToken();
    ...
    {
        return storageServiceMBean.getToken();
    }
