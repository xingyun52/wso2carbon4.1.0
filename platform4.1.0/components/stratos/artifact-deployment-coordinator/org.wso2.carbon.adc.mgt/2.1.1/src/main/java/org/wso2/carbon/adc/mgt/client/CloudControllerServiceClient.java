...
public class CloudControllerServiceClient {
	...
	public String describeCartridge(String cartridge) throws Exception {
		return stub.getCartridgeDescription(cartridge);
	}
	...
	public CartridgeInfo getCartridgeInfo(String cartridgeType) throws Exception {
