...
public class ServiceDiscoveryBean {
	...
	public List<String> getURLOfTheServer() {
		return urlOfTheServer;
	}

	public void setURLOfTheServer(List<String> urlOfTheServer) {
	...
	public void setServicesToAdd(List<String> serviceList) {
		this.servicesToAdd = serviceList;
	}
