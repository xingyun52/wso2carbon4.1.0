...
public class ContentBasedRouterMediator extends AbstractConnector {
    ...
    public void connect() {
        ...
        initParams(getMessageContext(), switchMediator);
        switchMediator.mediate(getMessageContext());
    }


    private void initParams(MessageContext synCtx, SwitchMediator switchMediator) {
        Object sourceXpath = lookupFunctionParam(synCtx, "routing_exp");
        ...
        String matchContent = (String) lookupFunctionParam(synCtx, "match_content");
