...
public class IdentityAuthorizationManager {
    ...
    private IdentityAuthorizationManager() {
        ...
        try {
            AuthorizationManager carbonAuthorizationManager = AuthorizationServiceComponent.
            ...
            if(carbonAuthorizationManager instanceof JDBCAuthorizationManager){
                this.carbonAuthorizationManager = (JDBCAuthorizationManager) carbonAuthorizationManager;
            } else {
    ...
    public void setAuthorization(String subject, String resource,
                                 String action, boolean authorized, boolean isRBAC)
                                                            throws IdentityAuthorizationException {

        if(log.isDebugEnabled()){
            log.debug("Persisting authorization for subject : " + subject + " resource : " + resource
                           + " and action : " + action);
        }

        try{
            carbonAuthorizationManager.addAuthorization(subject, resource, action, authorized, isRBAC);
        } catch (UserStoreException e) {
    ...
    public PermissionDTO[] getUserPermission(String userName, String moduleRoot){
        ...
        return permissionDTOs.toArray(new PermissionDTO[permissionDTOs.size()]);
    }


    public PermissionDTO[] getRolePermission(String roleName, String moduleRoot){
    ...
    public void clearUserPermissions(String subject, String resource, String action, boolean isRBAC)
        ...
        if(log.isDebugEnabled()){
            log.debug("Clearing authorization for subject : " + subject + " resource : " + resource
                           + " and action : " + action);
        }
