...
public interface AuthorizationContextTokenGenerator {
    ...
    AuthorizationContextToken generateToken(OAuth2TokenValidationRequestDTO reqDTO, OAuth2TokenValidationResponseDTO respDTO) throws IdentityOAuth2Exception;
