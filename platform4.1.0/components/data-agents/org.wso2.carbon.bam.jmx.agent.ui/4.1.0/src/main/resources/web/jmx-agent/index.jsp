...
<div id="middle">
    ...
    <div id="workArea">
        ...
        <h4><a class="icon-a" href="newProfile.jsp"><i class="icon-add"></i>Add profile</a>
        <a class="icon-a" href="index.jsp?addToolbox=true"><i class="icon-add"></i>Deploy toolbox profile</a></h4>
