 ...
 * under the License.
 */
package org.wso2.carbon.bam.data.publisher.clientstats.services;


import org.wso2.carbon.core.AbstractAdmin;
import org.wso2.carbon.bam.data.publisher.clientstats.config.EventingConfigData;
import org.wso2.carbon.bam.data.publisher.clientstats.config.RegistryPersistanceManager;

public class ClientStatisticsPublisherAdmin extends AbstractAdmin {
    private RegistryPersistanceManager registryPersistanceManager;

    public ClientStatisticsPublisherAdmin() {
