...
import org.wso2.carbon.bam.data.publisher.activity.mediation.stub.ActivityPublisherAdminStub;
import org.wso2.carbon.bam.data.publisher.activity.mediation.stub.config.EventingConfigData;
import org.wso2.carbon.bam.data.publisher.activity.mediation.stub.config.XPathConfigData;
...
public class ActivityPublisherAdminClient {
    ...
    private static final String BUNDLE = "org.wso2.carbon.bam.data.publisher.activity.mediation.ui.i18n.Resources";
    ...
    public void deleteXPathConfigData(XPathConfigData xpathConfigData) throws RemoteException {
        try {
            stub.deleteXPathData(xpathConfigData);
        } catch (Exception e){
            handleException(bundle.getString("cannot.delete.xpath.config"), e);    
        }
