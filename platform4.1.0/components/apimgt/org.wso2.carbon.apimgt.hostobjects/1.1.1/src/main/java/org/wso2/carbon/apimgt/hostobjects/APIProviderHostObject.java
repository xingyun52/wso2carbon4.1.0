...
public class APIProviderHostObject extends ScriptableObject {
    ...
    public static NativeObject jsFunction_login(Context cx, Scriptable thisObj,
        ...
        try {
            ...
            if (authorized) {
                //Store session of gateway login
                HostObjectUtils.getConfigContext().setProperty(username, loginGateway(username, password));
    ...
    public static String loginGateway(String user, String password) throws AxisFault {
