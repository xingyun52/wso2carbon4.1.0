...
public abstract class AbstractAPIGatewayAdminClient {
     ...
     */
    protected void setup(Stub stub,String tenatUser) throws AxisFault {
        String cookie =ServiceReferenceHolder.getContextService().getServerConfigContext().getProperty(tenatUser).toString();// login();//
