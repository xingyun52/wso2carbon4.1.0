...
/**
 * Activator class of the URLRewriteMediator
 *
 */
public class URLRewriteMediatorActivator implements BundleActivator {

		private static final Log log = LogFactory.getLog(URLRewriteMediatorActivator.class);
		...
		public void stop(BundleContext arg0) throws Exception {
				if (log.isDebugEnabled()) {
						log.debug("Stopped the URLRewriteMediator component.");
				}
