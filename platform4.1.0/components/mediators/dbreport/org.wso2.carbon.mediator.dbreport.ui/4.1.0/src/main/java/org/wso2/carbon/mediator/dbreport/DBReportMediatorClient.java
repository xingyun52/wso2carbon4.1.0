 ...
 *
 */
public class DBReportMediatorClient {
    private NDataSourceAdminStub stub;

    public DBReportMediatorClient(String cookie, String backendServerURL,
    ...
    public static DBReportMediatorClient getInstance(ServletConfig config, HttpSession session)
            throws AxisFault {
        ...
        return new DBReportMediatorClient(cookie, backendServerURL, configContext);
    }
