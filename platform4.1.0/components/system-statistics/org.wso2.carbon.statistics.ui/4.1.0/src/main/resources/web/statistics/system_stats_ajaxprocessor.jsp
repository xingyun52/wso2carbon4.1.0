    ...
    <table width="100%">
        ...
        <script type="text/javascript">
            ...
            <%
                if (isSuperTenant) {
            %>
            graphUsedMemory.add(<%= getMemoryMetricInMB(systemStats.getUsedMemory().getValue(),systemStats.getUsedMemory().getUnit())%>);
            graphTotalMemory.add(<%= getMemoryMetricInMB(systemStats.getTotalMemory().getValue(),systemStats.getTotalMemory().getUnit())%>);
            ...
            %>
            <%! 
            public Double getMemoryMetricInMB(Double val, String unit) {
