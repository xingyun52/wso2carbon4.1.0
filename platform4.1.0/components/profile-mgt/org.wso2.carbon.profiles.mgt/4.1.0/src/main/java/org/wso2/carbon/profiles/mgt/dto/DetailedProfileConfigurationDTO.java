...
public class DetailedProfileConfigurationDTO {
	...
	public ProfileConfigurationDTO[] getProfileConfiguartions() {
		return profileConfiguartions;
	}

	public void setProfileConfiguartions(
			ProfileConfigurationDTO[] profileConfiguartions) {
		this.profileConfiguartions = profileConfiguartions;
	}
