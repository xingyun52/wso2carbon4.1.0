...
/**
 * @scr.component name="org.wso2.carbon.appfactory.events.notification.internal.AppFactoryEventNotificationComponent"
 *                immediate="true"
    ...
    protected void activate(ComponentContext context) {
        // BundleContext bundleContext = context.getBundleContext();
            if (log.isDebugEnabled()) {
                log.debug("Appfactory event notification bundle is activated");
            }
    }

    protected void deactivate(ComponentContext context) {
        if (log.isDebugEnabled()) {
            log.debug("Appfactory event notification bundle is deactivated");
        }
    }
