...
public class DependencyManagementAdminService extends AbstractAdmin {
    ...
    public boolean addDependency(String applicationKey, String stage, String name, String description, String value)
            throws AppFactoryException {

        int tenantId = DependencyUtil.getTenantId(applicationKey);

        try {
            RegistryPersistManager.addToRegistry(stage, name, value, description, tenantId);
        } catch (Exception e) {
    ...
    public boolean updateDependency(String applicationKey, String stage, String name, String description, String value) throws AppFactoryException {
        int tenantId = DependencyUtil.getTenantId(applicationKey);

        try {
            RegistryPersistManager.updateResource(stage, name, value, description, tenantId);
        } catch (Exception e) {
