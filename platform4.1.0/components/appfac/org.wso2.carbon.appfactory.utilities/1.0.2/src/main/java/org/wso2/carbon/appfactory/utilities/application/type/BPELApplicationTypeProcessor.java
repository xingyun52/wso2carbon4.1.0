...
public class BPELApplicationTypeProcessor extends AbstractApplicationTypeProcessor {
    @Override
    public void doVersion(String targetVersion, String currentVersion, String workingDirectory) throws AppFactoryException {
        AppVersionStrategyExecutor.doVersionForBPEL(targetVersion, new File(workingDirectory));
    }
