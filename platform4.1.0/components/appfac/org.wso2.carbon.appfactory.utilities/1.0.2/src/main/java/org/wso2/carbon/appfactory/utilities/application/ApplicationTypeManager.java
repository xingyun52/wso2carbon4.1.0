...
public class ApplicationTypeManager {
    ...
    public static void init(ApplicationTypeManager manager) throws AppFactoryException {
        ...
        for (String type : applicationTypes) {
            ...
            String propertyStrings[] = manager.configuration.getProperties(AppFactoryConstants.APPLICATION_TYPE_CONFIG + "." + type + ".Property");
            String propertyValue;
            for (String propertyName : propertyStrings) {
                propertyValue = manager.configuration.getFirstProperty(AppFactoryConstants.APPLICATION_TYPE_CONFIG + "." + type + ".Property." + propertyName);
            ...
            try {
                Class<ApplicationTypeManager> clazz = (Class<ApplicationTypeManager>) manager.getClass().getClassLoader().loadClass(className);
