...
public class AppVersionStrategyExecutor {
     ...
     * @return
     */
    public boolean doVersion(String currentVersion, String targetVersion, File workDir, String applicationType) {
        ...
        if (AppFactoryConstants.FILE_TYPE_DBS.equals(applicationType)) {
            ...
            return doVersionForBPEL(targetVersion, workDir);
     ...
     * @return
     */
    public static boolean doVersionForBPEL(String targetVersion, File workDir) {
        doVersionOnBPEL(targetVersion, workDir);
        return true;
    }
    ...
    public static void doVersionOnBPEL(String targetVersion, File workDir) {
        //change in pom.xml file
        doVersionOnPOM(targetVersion, workDir);
        //change in .bpel file
        doVersionOnBPELFile(targetVersion, workDir);
        //change in .wsdl file
        doVersionOnWSDLFile(targetVersion, workDir);
    ...
    private static void doVersionOnWSDLFile(String targetVersion, File workDir) {
        try {
