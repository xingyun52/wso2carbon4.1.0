...
7. Various bug fixes(https://wso2.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10765) & enhancements including stabilizing WSO2 Carbon.
...
For more details see
http://docs.wso2.org/wiki/display/Carbon401/WSO2+Carbon+Secure+Vault
