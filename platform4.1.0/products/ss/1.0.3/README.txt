...
Key Features of WSO2 Storage Server
==================================
...
=============================================
    ...
    - lib
	  Contains the basic set of libraries required to startup Storage Server
	  in standalone mode

	- repository
	  The repository where services and modules deployed in WSO2 Storage Server
	...
	- samples
	  ...
	  the functionality and capabilities of WSO2 Storage Server
	...
	- LICENSE.txt
	  ...
	  WSO2 Storage Server is distributed.
...
For more information on WSO2 Storage Server, visit the WSO2 Oxygen Tank (http://wso2.org)
