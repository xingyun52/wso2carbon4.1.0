...
public class KeyspaceManagementTenantAdminTestCase {
    ...
    public void setEnvironment() throws LoginAuthenticationExceptionException, RemoteException {
        ...
        cassandraTestHelper.initialize(2);
    ...
    @Test(description = "Add keyspace by tenant admin")
    public void addKeyspaceByTenantAdmin()
            throws Exception {
    ...
    @Test(dependsOnMethods = "addKeyspaceByTenantAdmin", description = "update keyspace by super tenant")
    public void updateKeyspaceByTenantAdmin()
            throws Exception {
        boolean isKeyspaceContains = false;
        KeyspaceInformation keyspaceInformation = new KeyspaceInformation();
        keyspaceInformation.setName(KEYSPACE_NAME);
    ...
    @Test(dependsOnMethods = {"addKeyspaceByTenantAdmin", "updateKeyspaceByTenantAdmin", "updateColumnFamilyByTenantAdmin", "addColumnFamilyByTenantAdmin", "addColumnByTenantAdmin", "updateColumnByTenantAdmin", "deleteColumnByTenantAdmin", "deleteColumnFamilyByTenantAdmin"}, description = "delete keyspace by tenant admin")
    public void deleteKeyspaceByTenantAdmin()
            throws Exception {
        assertTrue(cassandraKeyspaceAdminStub.deleteKeyspace(KEYSPACE_NAME));
    }

    @Test(dependsOnMethods = {"addKeyspaceByTenantAdmin", "updateKeyspaceByTenantAdmin"}, description = "Add column family by tenant admin")
    public void addColumnFamilyByTenantAdmin()
            throws Exception {
    ...
    @Test(dependsOnMethods = {"addKeyspaceByTenantAdmin", "updateKeyspaceByTenantAdmin", "addColumnFamilyByTenantAdmin"}, description = "Update column family by tenant admin")
    public void updateColumnFamilyByTenantAdmin()
            throws Exception {
        boolean isCFContains = false;
    ...
    @Test(dependsOnMethods = {"addKeyspaceByTenantAdmin", "updateKeyspaceByTenantAdmin", "updateColumnFamilyByTenantAdmin", "addColumnFamilyByTenantAdmin", "addColumnByTenantAdmin", "updateColumnByTenantAdmin", "deleteColumnByTenantAdmin"}, description = "Delete column family by tenant admin")
    public void deleteColumnFamilyByTenantAdmin()
            throws Exception {
        assertTrue(cassandraKeyspaceAdminStub.deleteColumnFamily(KEYSPACE_NAME, COLUMN_FAMILY_NAME));
    }

    @Test(dependsOnMethods = {"addKeyspaceByTenantAdmin", "updateKeyspaceByTenantAdmin", "updateColumnFamilyByTenantAdmin", "addColumnFamilyByTenantAdmin"}, description = "Add column family by super tenant")
    public void addColumnByTenantAdmin()
            throws Exception {
        KeyspaceInformation keyspaceInformation = cassandraKeyspaceAdminStub.getKeyspaceofCurrentUser(KEYSPACE_NAME);
        ColumnFamilyInformation columnFamilyInformation = CassandraClientHelper.getColumnFamilyInformationOfCurrentUser(keyspaceInformation, COLUMN_FAMILY_NAME);
    ...
    @Test(dependsOnMethods = {"addKeyspaceByTenantAdmin", "updateKeyspaceByTenantAdmin", "updateColumnFamilyByTenantAdmin", "addColumnFamilyByTenantAdmin", "addColumnByTenantAdmin", "updateColumnByTenantAdmin"}, description = "Add column family by tenant admin")
    public void deleteColumnByTenantAdmin()
            throws Exception {
        KeyspaceInformation keyspaceInformation = cassandraKeyspaceAdminStub.getKeyspaceofCurrentUser(KEYSPACE_NAME);
    ...
    @Test(dependsOnMethods = {"addKeyspaceByTenantAdmin", "updateKeyspaceByTenantAdmin", "updateColumnFamilyByTenantAdmin", "addColumnFamilyByTenantAdmin", "addColumnByTenantAdmin"}, description = "Update column family by tenant admin")
    public void updateColumnByTenantAdmin()
            throws Exception {
        KeyspaceInformation keyspaceInformation = cassandraKeyspaceAdminStub.getKeyspaceofCurrentUser(KEYSPACE_NAME);
        ColumnFamilyInformation columnFamilyInformation = CassandraClientHelper.getColumnFamilyInformationOfCurrentUser(keyspaceInformation, COLUMN_FAMILY_NAME);
        ColumnInformation columnInformation = CassandraClientHelper.getColumnInformation(columnFamilyInformation, COLUMN_NAME);
    ...
    public void cleanUp() throws Exception {
        if (cassandraKeyspaceAdminStub.listKeyspacesOfCurrentUser() != null) {
            for (String keyspace : cassandraKeyspaceAdminStub.listKeyspacesOfCurrentUser()) {
                if (KEYSPACE_NAME.equals(keyspace)) {
