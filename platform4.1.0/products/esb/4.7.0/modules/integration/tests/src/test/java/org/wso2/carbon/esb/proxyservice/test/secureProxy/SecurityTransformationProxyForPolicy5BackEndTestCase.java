...
public class SecurityTransformationProxyForPolicy5BackEndTestCase extends ESBIntegrationTest {
    ...
    public void securityPolicy1() throws Exception {
        ...
        OMElement response;
        for (int i = 0; i < 5; i++) {
            response = secureServiceClient.sendSecuredStockQuoteRequest(userInfo, getProxyServiceSecuredURL(serviceName), policyId, symbol);
    ...
    public void securityPolicy2() throws Exception {
        ...
        OMElement response;
        for (int i = 0; i < 5; i++) {
            response = secureServiceClient.sendSecuredStockQuoteRequest(userInfo, getProxyServiceURL(serviceName), policyId, symbol);
            verifyResponse(response);
        }
