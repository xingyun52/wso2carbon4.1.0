...
public class IterateRegistryAsTargetTestCase extends ESBIntegrationTest {
	...
	public void testGovernersSequence() throws Exception, InterruptedException {
		loadESBConfigurationFromClasspath("/artifacts/ESB/mediatorconfig/iterate/iterate_target_govenerce.xml");
		URL url =
		          getClass().getResource("/artifacts/ESB/mediatorconfig/iterate/iterateLogAndSendSequence.xml");
	...
	public void testConfigurationSequence() throws Exception, InterruptedException {
