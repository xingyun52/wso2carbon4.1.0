...
public class ValidateIntegrationTestCase extends ESBIntegrationTest {
    ...
    public void uploadConfig()
        ...
        resourceAdminServiceStub.addResource("/_system/config/validate/schema.xml", "application/xml", "schema files", new DataHandler(new URL("file:///" + getClass().getResource("/artifacts/ESB/mediatorconfig/validate/schema.xml").getPath())));
        Thread.sleep(1000);
    }
