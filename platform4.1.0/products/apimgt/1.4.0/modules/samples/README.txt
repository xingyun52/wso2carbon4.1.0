...
You will find 3 subdirectories containing the instructions to run the above samples.
...
All 3 samples are based on live APIs, openly available on the web. Therefore when
