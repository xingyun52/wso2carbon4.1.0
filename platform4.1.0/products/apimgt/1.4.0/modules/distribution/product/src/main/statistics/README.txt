...
1. WSO2 BAM latest snapshot (WSO2 BAM 2.0.0-SNAPHOT)
2. Java Runtime Environment

NOTE:
You can download a latest snapshot of WSO2 BAM from http://people.wso2.com/~hiranya/wso2bam-2.0.0-SNAPSHOT.zip
This build has a known issue where it doesn't work on MS-Windows based systems. You can
use an official BAM milestone released after 19th July 2012 to test the BAM functionality on
Windows.
