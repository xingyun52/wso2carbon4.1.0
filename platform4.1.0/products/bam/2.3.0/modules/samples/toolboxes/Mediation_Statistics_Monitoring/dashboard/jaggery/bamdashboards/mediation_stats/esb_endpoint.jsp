  ...
  <div class="row-fluid">
    ...
    <div class="span10">
      <div class="well topFilteringPanel"><span class="span3"><nobr>Server :
          ...
          <span class="span3"><nobr>Endpoint Name :
	...
	<!-- gadget iframes -->
      <div class="hero-unit">
        <iframe id="dashboardWidget-1" class="single-column-gadget" src="gadgets/mult-line-dashboard-chart.jag?t=Now&rtype=Endpoint"></iframe>
      </div>
      <div class="row-fluid">
        <div class="hero-unit">
          <iframe id="dashboardWidget-2" src="gadgets/simple.bar.chart.jag?t=Now&rtype=Endpoint" class="single-column-gadget"></iframe>
        </div>
      </div>
      <div class="row-fluid">
        <div class="span4">
          <iframe id="dashboardWidget-3" src="gadgets/gauge_InDirection.jag?t=Now&rtype=Endpoint" class="gadget-small"></iframe>
        </div><!--/span-->
        <div class="span4">
          <iframe id="dashboardWidget-4" src="gadgets/gauge_OutDirection.jag?t=Now&rtype=Endpoint" class="gadget-small gadget-larger-width"></iframe>
        </div><!--/span-->

      </div><!--/row-->
	<div class="row-fluid">
        
          <iframe id="dashboardWidget-5" src="gadgets/simple.pie.chart.jag?t=Now&rtype=Endpoint" class="bottom-row-single-column-gadget"></iframe>
        </div>
