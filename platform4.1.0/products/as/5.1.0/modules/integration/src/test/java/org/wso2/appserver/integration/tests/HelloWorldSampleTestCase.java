...
//                ":" + FrameworkSettings.HTTPS_PORT + "/services/";
    ...
    public void securityScenariosTestCase() throws Exception {
        ...
        configureOverallSecurity();
        for (int scenarioNumber = 15; scenarioNumber >= 1; scenarioNumber--) { //reversed the order because we have to manually enable http transport after disabling 1st sec scenario.
