...
package jaggery.integration.tests.emailhostobject;
...
/**
 * This class sends requests to email.jag and validates the response
 */
public class EmailHostObjectTestCase extends ASIntegrationTest {
    ...
    public void testEmail() throws Exception {
        ...
        URL jaggeryURL = new URL(asServer.getWebAppURL() + "/testapp/email.jag");
        ...
        assertEquals(response, "email successfully sent");
    }
}
