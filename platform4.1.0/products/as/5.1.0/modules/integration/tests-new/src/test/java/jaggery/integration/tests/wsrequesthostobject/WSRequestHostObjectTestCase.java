 ...
 */
package jaggery.integration.tests.wsrequesthostobject;
 ...
 */
public class WSRequestHostObjectTestCase extends ASIntegrationTest {

    private static final Log log = LogFactory.getLog(WSRequestHostObjectTestCase.class);
    ...
    @Test(groups = {"wso2.as"}, description = "Test for WSRequest host object")
    public void testWSRequestExist() throws Exception {

        String response = null;
        URL jaggeryURL = new URL(asServer.getWebAppURL() + "/testapp/wsrequest.jag");
    ...
    public void testWSRequestOperations() throws Exception {
        ...
        in.close();
        log.info("Response: " + response);
        assertEquals(response, "014 success");
    }
}
