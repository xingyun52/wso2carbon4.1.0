...
cd %WSO2AppServer_HOME%
set CLIENT_CLASSPATH=.\samples\STS\conf;.\samples\STS\temp\classes
...
%_RUNJAVA% %JAVA_OPTS% -Dwso2appserver.home="%WSO2AppServer_HOME%" -cp "%CLIENT_CLASSPATH%" -Djava.endorsed.dirs="%WSO2AppServer_HOME%\lib\endorsed";"%JAVA_HOME%\jre\lib\endorsed";"%JAVA_HOME%\lib\endorsed" org.wso2.appserver.sample.sts.client.Client %*
cd %CURRENT_DIR%
endlocal
:end
