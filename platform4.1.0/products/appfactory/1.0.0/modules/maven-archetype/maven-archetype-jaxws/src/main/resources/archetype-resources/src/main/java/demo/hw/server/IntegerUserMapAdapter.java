...
/**
 * IntegerUserMapAdapter class is use for marshal/unmarshal the  Map/IntegerUserMap.
 *
 */
public class IntegerUserMapAdapter extends XmlAdapter<IntegerUserMap, Map<Integer, User>> {
	...
	/**
	 * Custom marshaling the Map<Integer, User> to IntegerUserMap
	 */
    ...
    /**
     * Custom unmarshaling the IntegerUserMap to Map<Integer, User>
     */
