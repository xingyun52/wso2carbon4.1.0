...
axis2_stub_t *
appfactory_svnauth_stub_create_with_endpoint_ref_and_client_home(
    ...
    const axutil_env_t * env)
{
    ...
    op_qname = axutil_qname_create(env, "hasAccess", "", NULL);
...
axis2_stub_t *
appfactory_svnauth_stub_create_with_endpoint_uri_and_client_home(
    const axutil_env_t * env,
...
axiom_node_t *
appfactory_svnauth_stub_call_hasAccess(
    axis2_stub_t * stub,
    const axutil_env_t * env,
    axiom_node_t * node,char *un,char *pw)
{
    ...
    axis2_options_set_http_auth_info(options, env, un, pw, "Basic");
