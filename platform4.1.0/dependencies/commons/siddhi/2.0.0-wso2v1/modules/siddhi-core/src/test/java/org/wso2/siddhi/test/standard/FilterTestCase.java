...
//        InputHandler inputHandler = siddhiManager.getInputHandler("cseEventStream");
    ...
    public void testFilterQuery24() throws InterruptedException {
        ...
        query.project(QueryFactory.outputProjector().project("symbol", Expression.variable("symbol")).project("price", Expression.variable("price")));
    ...
    public void testFilterQuery27() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[volume != 50d ] insert into outputStream symbol,price,volume;");
    ...
    public void testFilterQuery28() throws InterruptedException {
        ...
        query.insertInto("outputStream");
        query.project(QueryFactory.outputProjector().project("symbol", Expression.variable("symbol")).project("price", Expression.variable("price")).project("volume", Expression.variable("volume")));
    ...
    public void testFilterQuery34() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[price != 50 ] insert into outputStream symbol,price,volume;");
    ...
    public void testFilterQuery35() throws InterruptedException {
        ...
        InputHandler inputHandler = siddhiManager.defineStream("define stream cseEventStream (symbol string, price double, volume int)");
        String queryReference = siddhiManager.addQuery("from cseEventStream[price != 50f ] insert into outputStream symbol,price,volume;");
    ...
    public void testFilterQuery38() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[validity != true ] insert into outputStream symbol,price,volume;");
    ...
    public void testFilterQuery48() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[volume > 50d] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery50() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[volume == 60d ] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery51() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[volume == 60f ] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery52() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[volume == 60 ] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery54() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[price == 50d ] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery55() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[price == 50f ] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery56() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[price == 70 ] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery58() throws InterruptedException {
        ...
        query.insertInto("outputStream");
        query.project(QueryFactory.outputProjector().project("symbol", Expression.variable("symbol")).project("price", Expression.variable("price")).project("quantity", Expression.variable("quantity")));
        String queryReference = siddhiManager.addQuery(query);
        siddhiManager.addCallback(queryReference, new QueryCallback() {
            @Override
            public void receive(long timeStamp, Event[] inEvents, Event[] removeEvents) {
    ...
    public void testFilterQuery63() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[volume == 40d ] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery64() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[volume == 40f ] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery65() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[volume == 40 ] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery66() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[not(volume == 40)] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery67() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[price <= 60d] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery68() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[price <= 100f] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery69() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[price <= 50] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery77() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[volume <= 50f] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery78() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[volume <= 50] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery81() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[volume < 70f] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery88() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[price < 55f] insert into outputStream symbol,price;");
    ...
    public void testFilterQuery89() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[quantity < 50d] insert into outputStream symbol,price,quantity;");
    ...
    public void testFilterQuery90() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[quantity < 10f] insert into outputStream symbol,price,quantity;");
    ...
    public void testFilterQuery91() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[quantity < 15] insert into outputStream symbol,price,quantity;");
    ...
    public void testFilterQuery92() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[volume < 100d] insert into outputStream symbol,price,quantity;");
    ...
    public void testFilterQuery93() throws InterruptedException {
        ...
        String queryReference = siddhiManager.addQuery("from cseEventStream[volume < 100f] insert into outputStream symbol,price,quantity;");
    ...
    public void testFilterQuery108() throws InterruptedException {
        ...
        query.project(
                QueryFactory.outputProjector().
                        project("symbol", Expression.variable("symbol")).
                        project("increasedPrice", Expression.add(Expression.value(100), Expression.variable("price"))).
                        project("increasedVolume", Expression.add(Expression.value(50), Expression.variable("volume"))).
                        project("increasedQuantity", Expression.add(Expression.value(4), Expression.variable("quantity")))
    ...
    public void testFilterQuery109() throws InterruptedException {
        ...
        query.project(
                QueryFactory.outputProjector().
                        project("symbol", Expression.variable("symbol")).
                        project("decreasedPrice", Expression.minus(Expression.variable("price"), Expression.value(20))).
                        project("decreasedVolume", Expression.minus(Expression.variable("volume"), Expression.value(50))).
                        project("decreasedQuantity", Expression.minus(Expression.variable("quantity"), Expression.value(4)))
    ...
    public void testFilterQuery110() throws InterruptedException {
        ...
        query.project(
                QueryFactory.outputProjector().
                        project("symbol", Expression.variable("symbol")).
                        project("dividedPrice", Expression.divide(Expression.variable("price"), Expression.value(2))).
                        project("dividedVolume", Expression.divide(Expression.variable("volume"), Expression.value(2)))
    ...
    public void testFilterQuery111() throws InterruptedException {
        ...
        query.project(
                QueryFactory.outputProjector().
                        project("symbol", Expression.variable("symbol")).
                        project("multipliedQuantity", Expression.multiply(Expression.variable("quantity"), Expression.value(4)))
    ...
    public void testFilterQuery112() throws InterruptedException {
        ...
        query.project(
                QueryFactory.outputProjector().
                        project("symbol", Expression.variable("symbol")).
                        project("modPrice", Expression.mod(Expression.variable("price"), Expression.value(2))).
                        project("modVolume", Expression.mod(Expression.variable("volume"), Expression.value(2))).
                        project("modQuantity", Expression.mod(Expression.variable("quantity"), Expression.value(2))).
                        project("modAwards", Expression.mod(Expression.variable("awards"), Expression.value(2)))
    ...
    @Test(expected = StreamNotExistException.class)
