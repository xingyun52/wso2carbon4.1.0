...
public class SetProcessor implements CommandProcessor {
  ...
  private CommandProcessorResponse setVariable(String varname, String varvalue){
    ...
    if (varname.startsWith(SetProcessor.ENV_PREFIX)){
      ...
      HiveContext.getCurrentContext().getConf().set(propName, new VariableSubstitution().substitute(ss.getConf(),varvalue));
      return new CommandProcessorResponse(0);
      ...
      HiveContext.getCurrentContext().getConf().set(varname, new VariableSubstitution().substitute(ss.getConf(),varvalue));
      return new CommandProcessorResponse(0);
    }
  }
  ...
  private CommandProcessorResponse getVariable(String varname){
    ...
    if (varname.startsWith(SetProcessor.SYSTEM_PREFIX)){
      ...
      if (/**ss.getConf().get(var)!=null**/ HiveContext.getCurrentContext().getConf().get(var)!=null){
