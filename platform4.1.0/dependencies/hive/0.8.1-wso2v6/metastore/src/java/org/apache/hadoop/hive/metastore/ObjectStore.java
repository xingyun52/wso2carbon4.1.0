...
public class ObjectStore implements RawStore, Configurable {
  ...
  AtomicInteger openTrasactionCalls = new AtomicInteger(0);
  ...
  public boolean openTransaction() {
    synchronized (this) {
    int openTransactions = openTrasactionCalls.incrementAndGet();
  ...
  public boolean commitTransaction() {
    ...
    synchronized (this) {
    int openTransactions = openTrasactionCalls.decrementAndGet();
    if ((openTransactions == 0) && currentTransaction.isActive()) {
