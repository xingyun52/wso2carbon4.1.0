...
public class CassandraDataAccessHelper {
    ...
    public static List<String> getDestinationQueueNamesFromCounterColumns(String columnFamilyName, String rowName, Keyspace keyspace) throws CassandraDataAccessException {
        ArrayList<String> rowList = new ArrayList<String>();
      ...
      /**
     * Get the value of a given column in a Given ROW in a Cassandra Column Family
     * Here we assume that the columns in a given row have string data and key and value in the given column
     * in that row have same values.
     * @param columnFamilyName Name of the column Family
     * @param rowName  Row name
     ...
     * @throws CassandraDataAccessException   In case of database access error or data error
     */
    public static String getColumnValue(String columnFamilyName, String rowName,Keyspace keyspace, String columnName) throws CassandraDataAccessException {
        ArrayList<String> rowList = new ArrayList<String>();
        String value = null;
