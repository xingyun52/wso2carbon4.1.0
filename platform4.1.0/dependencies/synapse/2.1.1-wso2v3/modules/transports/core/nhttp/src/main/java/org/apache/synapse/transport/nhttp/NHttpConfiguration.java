...
public final class NHttpConfiguration {
    ...
    public String getNhttpLogDirectory() {
        Properties synapseProps = MiscellaneousUtil.loadProperties(NhttpConstants.NHTTP_PROPERTIES);
        return synapseProps.getProperty(NhttpConstants.NHTTP_LOG_DIRECTORY);
    }
}
