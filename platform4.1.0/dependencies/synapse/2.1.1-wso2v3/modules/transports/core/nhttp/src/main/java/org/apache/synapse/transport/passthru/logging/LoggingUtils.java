...
public class LoggingUtils {
    public final static String HEADER_LOG_ID = "org.apache.synapse.transport.passthru.headers";
    public final static String WIRE_LOG_ID = "org.apache.synapse.transport.passthru.wire";
    public final static String ACCESS_LOG_ID = "org.apache.synapse.transport.passthru.access";
    ...
    public static NHttpClientIOTarget createClientConnection(
        ...
        Log accesslog = LogFactory.getLog(ACCESS_LOG_ID);
        if (headerlog.isDebugEnabled() || log.isDebugEnabled() || accesslog.isInfoEnabled()) {
